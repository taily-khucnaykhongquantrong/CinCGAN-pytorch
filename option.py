...
parser.add_argument(
    "--n_threads", type=int, default=3, help="number of threads for data loading"
)
...
parser.add_argument(
    "--offset_val", type=int, default=800, help="validation index offest"
)
parser.add_argument(
    "--offset_train", type=int, default=0, help="validation index offest"
)
...
parser.add_argument("--quality", type=str, default="", help="jpeg compression quality")
parser.add_argument(
...
parser.add_argument(
    "--testset", type=str, default="B100", help="dataset name for testing"
)
...
parser.add_argument(
    "--lr_decay", type=int, default=40, help="learning rate decay per N epochs"
)
parser.add_argument(
